...
BLOG_AUTHOR = "Bertrand Servin"  # (translatable)
BLOG_TITLE = "Bertrand Servin"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bertrandservin.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://bertrandservin.github.io/"
BLOG_EMAIL = "bertrand.servin@inra.fr"
BLOG_DESCRIPTION = "Bertrand Servin's GitHub pages"  # (translatable)
